...
const ALLOWED_BINDINGS = {
  ...
  'src/renderer/panels/settings-shortcuts.js': [],
  ...
  'src/renderer/shell/away-overview-view.js': [],
  'src/renderer/shell/terminal-pressure.js': [],
  'src/renderer/shell/pixel-icon.js': [],
  ...
  'src/renderer/shell/command-palette.js': [],
  ...
  'src/renderer/views/text-sync.js': [],
