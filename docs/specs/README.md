...
| 17 | [Detached session windows](17-detached-windows.md) — **built**; the routing separation and the one-session-one-renderer invariant | #2 | No — main-process routing + every renderer mount path |
