...
(function () {
  ...
  async function openSettingsViewer(scope, projectPath) {
    ...
    const awayIdleMinutesValue = fieldValue('awayIdleMinutes', 10);
    ...
    if (isProject) {
      ...
      settingsViewerBody.classList.add('sv-two-pane');
      // The form itself — the nav and every category pane — is panels/settings-global-html.js
    ...
    async function persistSettings() {
      ...
      if (isProject) {
        ...
        settings.awayIdleMinutes = Math.max(1, Math.min(240, parseInt(settingsViewerBody.querySelector('#sv-away-idle-minutes')?.value, 10) || 10));
        {
