              ...
              <div class="settings-section">
                <div class="settings-field">
                  <div class="settings-field-info">
                    ...
                    <div class="settings-description">Menu, copy/paste (Windows style), copy while selecting, a selection action bar, or the native xterm default.</div>
                    <div class="settings-more"><b>Menu</b>: context menu with file-link actions, copy &amp; paste. <b>Copy or paste</b>: copy the selection, or paste when nothing is selected. <b>Copy on selection</b>: finishing a selection copies it and the right button always pastes (the X11 / PuTTY split). <b>Selection bar + paste</b>: selecting text pops a floating action bar (Copy / Create task); right-click pastes, or opens the menu over a link. <b>Native</b>: xterm default. Takes effect on the next right-click.</div>
                  </div>
                  <div class="settings-field-control">
                    <select class="settings-select" id="sv-right-click">
                      ...
                      <option value="copy-on-select" ${rightClickValue === 'copy-on-select' ? 'selected' : ''}>Copy on selection, right-click pastes</option>
