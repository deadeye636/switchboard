...
const quitGuard = require('./app/quit-guard');
...
const settingsTransfer = require('./app/settings-transfer');
...
const { discoverShellProfiles, getShellProfiles, invalidateShellProfiles, resolveShell, isWindows, isWslShell, windowsToWslPath, shellArgs, ptyShellArgs, quoteArgvForShell } = require('./app/terminal/shell-profiles');
const { startScheduler } = require('./servers/schedule-runner');
const { encodeProjectPath } = require('./session/encode-project-path');
const { afkTimeoutToEnvMs, resolveAfkTimeoutSec } = require('./app/terminal/afk-timeout');
