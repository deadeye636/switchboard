...
function ensureWorker() {
  ...
  // `'..'` because this file sits in src/index/ while the worker is in src/workers/. A Worker spawn is
  // not a require: no test spawns it, the packaged-files graph walk cannot see it, and getting it wrong
  // surfaces as cold-start indexing that quietly finds nothing.
