...
| `src/app/**` | the areas main.js used to hold — lifecycle, windows, notifications, hooks, variables, settings, quit-guard, session-shutdown, settings-transfer, plans-memory, vcs, detach, presence, timeline, `terminal/` |
